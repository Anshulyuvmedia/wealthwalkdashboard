...
const AddSignal = () => {
    ...
    return (
        <SidebarProvider
            ...
            <SidebarInset>
                <SiteHeader title="Add Signal" />
                <div className="flex flex-1 flex-col gap-6 p-4 md:p-6">
                    <form onSubmit={handleSubmit} className="space-y-8">
                        <div className="flex justify-between gap-4">
                            <div>
                                <h1 className="text-3xl font-bold">Add New {signalType} Signal</h1>
                            </div>
                        ...
                        <Card>
                            <CardHeader>
                                <CardTitle>{signalType} Signal Details</CardTitle>
                            </CardHeader>
